 ...
 * second poller of its own. `cloudCheckout` is the cloud thread's answer to the probe: the
 * lift-time git identity folded out of the log, null for anything local.
 */
