...
const description = [
  ...
  'The layer picks the target: user is the Atlas Cloud account when signed in, otherwise the local user mcp file; project is <cwd>/.atlas/mcp.json, project-compat is <cwd>/.mcp.json.',
