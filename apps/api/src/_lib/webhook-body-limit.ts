 ...
 * they get their own parser that rejects oversized bodies before buffering.
 */
 ...
 * @SkipThrottle(). A real GitHub sender delivers at most a few events a second and retries
